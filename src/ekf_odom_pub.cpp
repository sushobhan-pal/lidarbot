...
const double TICKS_PER_REVOLUTION = 20; // For reference purposes.
const double WHEEL_RADIUS = 0.0339; // Wheel radius in meters
const double WHEEL_BASE = 0.135; // Center of left tire to center of right tire
const double TICKS_PER_METER = 107; // Original was 2800
